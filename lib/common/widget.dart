...
abstract class AStatefulWB<S extends StatefulWidget, B extends ABloc> extends State<S> with ADisposableMixin {
  @protected
  B bloc;
...
abstract class AStatefulWBL<W extends StatefulWidget, B extends ABloc, L> extends AStatefulWB<W, B> {
  @protected
  L l10n;
